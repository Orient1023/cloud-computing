...
<c:if test="${not empty requestRefresh}">
...
<div class="container">
    <div class="row">
        <div class="panel" id="filePanel">
            <div class="card-header success-color-dark z-depth-2 white-text">
               <h4> 欢迎访问分布式文件系统</h4>
            ...
            <div class="pull-right">
                <span><button data-toggle="modal" class="btn btn-primary" data-target="#createDirModal">新建文件夹   <i class="fa fa-folder-open btn-large" style="color: palegreen"></i></button></span>
            </div>
                        ...
                        <td>
                            ...
                            <div class="collapse" id="collapseExample${status.count}" style="padding-left: 15px">
                                ...
                                <h6>存放位置如下：</h6>
                                    ...
                                    <c:forEach var="blockInfo" items="${item.blockInfos}" varStatus="blockStatus">
                                <h6>       <c:out value="${blockInfo.ipAddress}     " default=""></c:out>
                                            <c:out value="${blockInfo.hostname}   " default=""></c:out>
                                </h6>
                                    </c:forEach>
